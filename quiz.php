...
{	
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				$_SESSION[qn]=$_SESSION[qn]+1;
				echo "<Table align=center class='table'><tr class=tot><td>Total Question<td> $_SESSION[qn]";
				echo "<tr class=tans><td class='btn btn-success'>True Answer<td>".$_SESSION[trueans];
				$w=$_SESSION[qn]-$_SESSION[trueans];
				echo "<tr class=fans><td class=''>Wrong Answer<td> ". $w;
				echo "</table>";
...
echo "<table class='table table-reponsive' width=100%> <tr> <td width=30>&nbsp;<td> <table border=0>";
$n=$_SESSION[qn]+1;
...
if($_SESSION[qn]<mysql_num_rows($rs)-1)
echo "<tr><td><input type=submit name='submit' class='btn btn-success' value='Next Question'></form>";
else
echo "<tr><td><input type=submit name='submit' class='btn btn-success'value='Get Result'></form>";
echo "</table></table>";
?>
